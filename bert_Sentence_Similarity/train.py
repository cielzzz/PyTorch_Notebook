...
logging.basicConfig(format = '%(asctime)s - %(levelname)s - %(name)s - %(message)s',
                    ...
                    level= logging.INFO)
logger = logging.getLogger(_name__) #这里的name理解为，参数传的是__name__，值为__main__
#即__name__这个属性是指调用的模块名称，1、如果该模块被导入其他主程序，则调用该模块的__name__就是该模块的名称2、如果直接作为主程序，就是__main__
...
if __name__ == "__main__":
    main("./data/train.csv", "./data/test.csv", "./data/models/")